...
exports.searchCompanies = asyncHandler(async (req, res, next) => {
  try {
    ...
    .select('_id name logoUrl verified industry')
    .limit(10);
...
// Add this new method (around line 215)

/**
 * @desc    Get public company profile (NO AUTH REQUIRED)
 * @route   GET /api/v1/company/public/:id
 * @access  Public
 */
