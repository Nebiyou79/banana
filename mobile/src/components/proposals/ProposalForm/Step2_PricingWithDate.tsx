// src/components/proposals/ProposalForm/Step2_PricingWithDate.tsx
// Step 2: Bid amount, bid type, currency, delivery time, availability, and start date
...
export const Step2_PricingWithDate: React.FC<Step2Props> = ({
  bidType,
  proposedAmount,
  currency,
  hourlyRate = '',
  ...
  return (
    <ScrollView style={[styles.container, style]} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.stepHeader}>
        ...
        <View>
          <Text style={[styles.stepTitle, { color: colors.text }]}>Pricing & Timeline</Text>
      ...
      {/* Hourly extras */}
      {bidType === 'hourly' && onHourlyRateChange && onWeeklyHoursChange && (
      ...
      {tenderBudget && (tenderBudget.min > 0 || tenderBudget.max > 0) && (
        <View
          style={[
            styles.budgetHint,
            {
              backgroundColor: isOutsideBudget ? 'rgba(245,158,11,0.08)' : 'rgba(16,185,129,0.06)',
        ...
        >
          ...
          {proposedStartDate && (
            <>
              <View style={styles.summaryDivider} />
              <View style={styles.summaryItem}>
                <Text style={[styles.summaryLabel, { color: colors.textMuted }]}>Start Date</Text>
                <Text style={[styles.summaryValue, { color: colors.text }]}>
...
const styles = StyleSheet.create({
  ...
  textInput: { height: 46, borderWidth: 1.5, borderRadius: 12, paddingHorizontal: 14, fontSize: 15, fontWeight: '500' },
  ...
  currencyBtn: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 10, borderWidth: 1.5 },
  ...
  availCard: { flex: 1, borderWidth: 1.5, borderRadius: 12, padding: 12, alignItems: 'center', gap: 4, position: 'relative' },
  availIcon: { fontSize: 20 },
  availLabel: { fontSize: 12, fontWeight: '700', textAlign: 'center' },
  availDesc: { fontSize: 10, textAlign: 'center' },
  activeDot: { position: 'absolute', top: 6, right: 6, width: 7, height: 7, borderRadius: 3.5, backgroundColor: '#10B981' },
  bidTypeRow: { flexDirection: 'row', gap: 10 },
  bidTypeCard: { flex: 1, borderWidth: 1.5, borderRadius: 12, padding: 14, alignItems: 'center', gap: 5, position: 'relative' },
  bidTypeIcon: { fontSize: 22 },
  bidTypeTitle: { fontSize: 13, fontWeight: '700', textAlign: 'center' },
  bidTypeDesc: { fontSize: 11, textAlign: 'center' },
  selectedDot: { position: 'absolute', top: 8, right: 8, width: 14, height: 14, borderRadius: 7, backgroundColor: '#F1BB03', alignItems: 'center', justifyContent: 'center' },
  selectedDotInner: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#0A2540' },
  summaryBox: { flexDirection: 'row', borderWidth: 1, borderRadius: 14, overflow: 'hidden', marginTop: 12 },
...
export default Step2_PricingWithDate;