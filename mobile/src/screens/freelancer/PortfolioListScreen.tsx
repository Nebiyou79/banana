/**
 * screens/freelancer/PortfolioListScreen.tsx
 */
...
const styles = StyleSheet.create({
  statsRow:       { flexDirection: 'row', marginHorizontal: 16, marginTop: 16, marginBottom: 12, borderRadius: 16, borderWidth: 1, overflow: 'hidden' },
