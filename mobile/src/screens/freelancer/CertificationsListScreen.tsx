...
const CertCard: React.FC<{
  ...
  const formatDate = (d?: string) => d ? new Date(d).toLocaleDateString('en-US', { month: 'short', year: 'numeric' }) : null;
  ...
  return (
    <View style={[styles.certCard, {
      ...
      <View style={styles.certHeader}>
        <View style={[styles.certIcon, { backgroundColor: colors.primaryLight, borderRadius: borderRadius.md }]}>
        ...
        <View style={[styles.skillsRow, { marginTop: spacing[3] }]}>
          {cert.skills.slice(0, 4).map((s, i) => (
            <View key={i} style={[styles.skillTag, { backgroundColor: colors.primaryLight, borderRadius: 8 }]}>
              <Text style={{ fontSize: 9, fontWeight: '600', color: colors.primary }}>{s}</Text>
            </View>
          ))}
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <EmptyState
            ...
            subtitle="Add your professional certifications to boost your profile credibility and attract better clients."
