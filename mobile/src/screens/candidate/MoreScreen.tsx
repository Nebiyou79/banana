 ...
 *
 * Candidate "More" hub — surfaces every screen not in the 5 main tabs:
 *   • CV Generator (Templates → Preview → Generated CVs)
 *   • Verification + Request Verification
 *   • Referrals & Rewards / Leaderboard
 *   • Product Marketplace
 *   • Account settings (placeholder)
 *   • Help, Terms, Contact (placeholder)
 *   • Sign Out
 */
...
const ACCENT = '#F59E0B'; // Candidate accent — amber
      ...
      >
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={[ms.rolePill, { backgroundColor: ACCENT + '18', marginTop: 4 }]}>
            ...
            <Text style={{ color: ACCENT, fontSize: typography.xs, fontWeight: '700' }}>Candidate</Text>
          </View>
        </View>
...
const ms = StyleSheet.create({
  ...
  signOutBtn:{
    ...
    borderWidth: 1, borderRadius: 14, paddingVertical: 14, marginBottom: 12,
  },
});