            ...
            <div className="grid grid-cols-3 gap-8 mb-12">
              {[
                ...
                <div key={index} className="text-center group">
                  <div
                    className={`w-14 h-14 rounded-xl flex items-center justify-center mx-auto mb-3 border backdrop-blur-sm transition-all duration-300 shadow-lg ${colorClasses.bg.darkNavy} ${colorClasses.border.gray800}`}
                  >
          ...
          <div className="lg:hidden flex justify-center items-center mt-4 mb-10">
            <div
              className={`
                ...
                dark:${colorClasses.border.gray800}
              `}
            >
              {/* Logo Container */}
              <div
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input
                            ...
                            disabled={isLoading}
                            className={`
                              pl-12 pr-4 py-3 h-12 rounded-xl focus:ring-2 transition-all duration-200 
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input
                            ...
                            disabled={isLoading}
                            className={`
                              pl-12 pr-12 py-3 h-12 rounded-xl focus:ring-2 transition-all duration-200 
                              text-base backdrop-blur-sm
                              ${colorClasses.border.gray400} ${colorClasses.bg.white}
                              dark:${colorClasses.border.gray700} dark:${colorClasses.bg.darkNavy}
                              dark:${colorClasses.text.white}
                  ...
                  <label className="flex items-center cursor-pointer">
                    <div className="relative">
                      ...
                      <div className={`
                        ...
                        ${rememberMe ? `${colorClasses.bg.goldenMustard} ${colorClasses.border.goldenMustard}` : `${colorClasses.border.gray400} ${colorClasses.bg.white}`}
                        dark:${colorClasses.border.gray700} dark:${colorClasses.bg.darkNavy}
                      `}>
                        {rememberMe && (
                    ...
                    <span className={`ml-3 text-sm font-medium ${colorClasses.text.gray800} dark:${colorClasses.text.gray300}`}>
                      Remember me
                    </span>
                  </label>
                  <Link
                    href="/forgot-password"
                    className={`text-sm font-semibold transition-colors ${colorClasses.text.blue} hover:${colorClasses.text.darkNavy}`}
                  >
                    Forgot password?
                  </Link>
                </div>
