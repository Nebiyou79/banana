  ...
  if (jobLoading) {
    return (
      <DashboardLayout requiredRole="organization">
        <div className="min-h-screen bg-linear-to-br from-emerald-50 to-teal-100 py-8">
      ...
      <div className="min-h-screen bg-linear-to-br from-emerald-50 to-teal-100 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 mb-8">
            <div className="space-y-3 flex-1">
              ...
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                <div>
                  <h1 className="text-3xl font-bold text-gray-900 mb-2 bg-linear-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
          ...
          <Card className="mb-8 border border-emerald-200 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-shadow">
            <CardContent className="p-6">
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div className="space-y-4 flex-1">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div className="flex items-start gap-4">
                      <div className="p-3 bg-linear-to-r from-emerald-100 to-teal-100 rounded-xl shadow-sm">
                ...
                <div className="flex flex-col items-center justify-center p-4 bg-linear-to-br from-emerald-50 to-teal-50 rounded-xl border border-emerald-200 min-w-[140px] shadow-sm">
          ...
          <Card className="border border-emerald-200 shadow-lg bg-white/80 backdrop-blur-sm">
            <CardHeader className="pb-4 border-b border-emerald-200 bg-linear-to-r from-emerald-50 to-white">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  <CardTitle className="flex items-center gap-3 text-2xl text-gray-900">
                    <div className="p-2 bg-linear-to-r from-emerald-600 to-teal-600 rounded-lg shadow-sm">
          ...
          <Card className="mt-8 border border-emerald-200 shadow-sm bg-linear-to-r from-emerald-50 to-teal-50">
            <CardContent className="p-6">
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
