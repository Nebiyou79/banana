        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8 animate-in slide-in-from-top-0 duration-500">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-3xl font-bold bg-linear-to-r from-primary to-secondary bg-clip-text text-transparent animate-text">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <div className="text-left">
                  <div className="font-medium">View and Edit Your Profile</div>
