...
export default function OrganizationProfilePage() {
    ...
    const renderOrganizationDetails = () => (
        <Card className="backdrop-blur-xl bg-linear-to-b from-white to-gray-100 border border-gray-200 rounded-3xl p-8 mb-8">
                        ...
                        <Card className="backdrop-blur-xl bg-linear-to-b from-white to-gray-100 border border-gray-200 rounded-3xl p-8">
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <Button
                                    ...
                                    className="bg-linear-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white"
                                >
                            ...
                            {projects.length > 0 ? (
                                ...
                                <div className="text-center py-12">
                                    <div className="w-20 h-20 rounded-full bg-linear-to-br from-green-500 to-emerald-500 flex items-center justify-center mx-auto mb-6">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            <div className="lg:col-span-2 space-y-6">
                                {[...Array(3)].map((_, i) => (
                                    <div key={i} className="backdrop-blur-xl bg-linear-to-b from-white to-gray-100 rounded-3xl p-8 border border-gray-200 animate-pulse">
                ...
                <RoleThemeProvider>
                    <Card className="backdrop-blur-xl bg-linear-to-b from-white to-gray-100 border border-gray-200 rounded-3xl p-8 text-center">
                        ...
                        <Button
                            ...
                            className="bg-linear-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white backdrop-blur-lg border-gray-300"
                        >
                            <PlusCircle className="w-4 h-4 mr-2" />
            ...
            <RoleThemeProvider>
                <div className="space-y-8 pb-20">
                    ...
                    <div className="fixed bottom-8 right-8 z-50 flex flex-col gap-3">
                        <Button
                            onClick={() => window.location.href = '/social/organization/projects/create'}
                            className="bg-linear-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white shadow-xl hover:shadow-2xl transition-all duration-300 group"
                            size="lg"
                        >
