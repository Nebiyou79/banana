...
const CandidateVerification = () => {
  ...
  if (isLoading) {
    return (
      <DashboardLayout>
        <div className={`min-h-screen ${colorClasses.bg.blueLight} flex items-center justify-center`}>
  ...
  if (!isAuthenticated) {
    return (
      <DashboardLayout>
        <div className={`min-h-screen ${colorClasses.bg.blueLight} flex items-center justify-center`}>
          <div className={`text-center max-w-md p-8 ${colorClasses.bg.white} rounded-2xl shadow-xl border ${colorClasses.border.blue}`}>
            <UserIcon className={`h-20 w-20 ${colorClasses.text.blue} mx-auto mb-6`} />
            <h2 className={`text-3xl font-bold ${colorClasses.text.darkNavy} mb-4`}>Candidate Verification</h2>
            <p className={`${colorClasses.text.gray600} mb-6`}>Login to start your verification process and unlock better opportunities</p>
            <button
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div>
                <div className="flex items-center mb-3">
                  ...
                  <div>
                    <h1 className={`text-3xl font-bold ${colorClasses.text.darkNavy} dark:text-white`}>Candidate Verification</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className={`${colorClasses.bg.white} dark:bg-gray-800 rounded-2xl shadow-lg p-6 border ${colorClasses.border.blue} dark:border-gray-700 hover:shadow-xl transition-all`}>
              <div className="flex items-center">
                <div className={`p-3 rounded-full ${colorClasses.bg.blueLight} dark:bg-blue-900/30 mr-4`}>
                  <ClockIcon className={`h-7 w-7 ${colorClasses.text.blue} dark:text-blue-400`} />
                </div>
                <div>
                  <div className={`text-2xl font-bold ${colorClasses.text.darkNavy} dark:text-white`}>3-5</div>
            ...
            <div className={`${colorClasses.bg.white} dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-green-200 dark:border-green-900/50 hover:shadow-xl transition-all`}>
              <div className="flex items-center">
                <div className={`p-3 rounded-full ${colorClasses.bg.greenLight} dark:bg-green-900/30 mr-4`}>
                  <CheckCircleIcon className={`h-7 w-7 ${colorClasses.text.green} dark:text-green-400`} />
                </div>
                <div>
                  <div className={`text-2xl font-bold ${colorClasses.text.darkNavy} dark:text-white`}>6</div>
                  <div className={`text-sm ${colorClasses.text.gray600} dark:text-gray-400`}>Categories</div>
                </div>
              </div>
            </div>
            ...
            <div className={`${colorClasses.bg.white} dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-orange-200 dark:border-orange-900/50 hover:shadow-xl transition-all`}>
              <div className="flex items-center">
                ...
                <div>
                  <div className={`text-2xl font-bold ${colorClasses.text.darkNavy} dark:text-white`}>30</div>
            ...
            <div className={`${colorClasses.bg.white} dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-purple-200 dark:border-purple-900/50 hover:shadow-xl transition-all`}>
              <div className="flex items-center">
                <div className={`p-3 rounded-full ${colorClasses.bg.purpleLight} dark:bg-purple-900/30 mr-4`}>
                  <CalendarIcon className={`h-7 w-7 ${colorClasses.text.purple} dark:text-purple-400`} />
                </div>
                <div>
                  <div className={`text-2xl font-bold ${colorClasses.text.darkNavy} dark:text-white`}>30-45</div>
              ...
              <div className={`${colorClasses.bg.white} dark:bg-gray-800 rounded-2xl shadow-lg p-6 mb-6 border ${colorClasses.border.blue} dark:border-gray-700`}>
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className={`p-4 ${colorClasses.bg.greenLight} dark:bg-green-900/20 rounded-xl border ${colorClasses.border.green} dark:border-green-800`}>
                    <h4 className={`font-medium ${colorClasses.text.green} dark:text-green-400 mb-2`}>✅ What to Expect</h4>
                ...
                <div className="mb-6">
                  <div className="flex items-center mb-3">
                    <div className={`p-2 ${colorClasses.bg.blueLight} dark:bg-blue-900/30 rounded-lg mr-3`}>
                      <DocumentCheckIcon className={`h-7 w-7 ${colorClasses.text.blue} dark:text-blue-400`} />
                    </div>
                    <div>
                      <h3 className={`text-xl font-bold ${colorClasses.text.darkNavy} dark:text-white`}>Complete Verification Checklist</h3>
                      <p className={`${colorClasses.text.gray600} dark:text-gray-400`}>All items below will be verified during your appointment</p>
                    </div>
                  </div>
                </div>
