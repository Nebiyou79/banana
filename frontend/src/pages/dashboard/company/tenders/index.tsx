...
const CompanyTendersPage: NextPage = () => {
  ...
  const handleEditTender = (tenderId: string) => {
    ...
    router.push(`/dashboard/company/tenders/${tenderId}/edit`);
  };
      ...
      <DashboardLayout requiredRole="company">
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">Only companies can access this page.</p>
            <button
  ...
  return (
    <DashboardLayout requiredRole="company">
      <Head>
        <title>My Tenders | Freelance Platform</title>
        <meta name="description" content="Manage your company's tenders and projects" />
      </Head>
        ...
        <div className={`${colorClasses.bg.darkNavy} text-white`}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              <div>
                <h1 className="text-3xl font-bold mb-2">My Tenders</h1>
                <p className="text-gray-300">Manage your company`s projects and tenders</p>
              </div>
              ...
              <div className="flex-1">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-goldenMustard focus:border-goldenMustard transition-colors"
                  />
                </div>
              </div>
              <div className="flex gap-3">
                <div className="relative">
                  <select
                    ...
                    className="appearance-none pl-4 pr-10 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-goldenMustard focus:border-goldenMustard transition-colors min-w-[150px] bg-white"
                  >
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 px-3 py-2 text-sm text-blue-600 hover:text-blue-800 transition-colors font-medium group/action"
                          title="Edit tender"
                        >
