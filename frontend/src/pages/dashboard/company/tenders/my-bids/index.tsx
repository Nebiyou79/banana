// pages/dashboard/company/tenders/my-bids/index.tsx
// Company owner — "My Bids" dashboard.
// Stats header → large TenderBidCard grid (one card per posted tender).
// Sealed tender card: shows deadline countdown + sealed bid count.
// Open tender card: shows applicant company avatars + names.
// Click → /dashboard/company/tenders/my-bids/[tenderId]/bids
...
// ─────────────────────────────────────────────────────────────────────────────
// Live countdown hook (updates every minute)
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Sealed body — deadline countdown + bid/sealed counts
// ─────────────────────────────────────────────────────────────────────────────
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold bg-[#0A2540] text-white shadow-sm">
          <span>📬</span>
...
// ─────────────────────────────────────────────────────────────────────────────
// Open body — applicant avatars + name list
// ─────────────────────────────────────────────────────────────────────────────
            ...
            {visible.map((bid, i) => {
              ...
              return logo ? (
                ...
                <div key={bid._id} title={name}
                  style={{ backgroundColor: '#0A2540', zIndex: 10 - i }}
...
// ─────────────────────────────────────────────────────────────────────────────
// TenderBidCard — self-fetches its bids
// ─────────────────────────────────────────────────────────────────────────────
  ...
  return (
    <div
      ...
      className={[
        ...
        'focus:outline-none focus:ring-2 focus:ring-[#F1BB03]/40',
      ].join(' ')}
    >
      {/* Top colour stripe */}
      <div className="h-1.5" style={{ backgroundColor: isSealed ? '#8B5CF6' : '#10B981' }} />
      ...
      <div className="p-5">
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          ...
          <div className="flex flex-col items-end gap-1.5 shrink-0">
            ...
            <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${isSealed ? `${colorClasses.bg.purpleLight} ${colorClasses.text.purple}` : 'bg-[#D1FAE5] dark:bg-[#064E3B]/60 text-[#047857] dark:text-[#34D399]'}`}>
        ...
        <div className={`flex items-center justify-between mt-4 pt-3 border-t ${colorClasses.border.secondary}`}>
          ...
          <span className="text-xs font-bold text-[#0A2540] dark:text-[#F1BB03]">View Bids →</span>
        </div>
      </div>
    </div>
  );
...
export default function CompanyMyBidsIndexPage() {
      ...
      <div className="p-5 sm:p-8 space-y-8">
        ...
        <div>
          ...
          <p className={`text-sm ${colorClasses.text.muted} mt-1`}>
            Monitor bids across all your posted tenders.
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className={`rounded-2xl border ${colorClasses.border.secondary} ${colorClasses.bg.surface} flex flex-col items-center justify-center py-20 text-center px-6`}>
            ...
            {!search && (
              <button
                onClick={() => router.push('/dashboard/company/tenders/create')}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
            {filtered.map((tender) => (
              <TenderBidCard
                key={tender._id}
                tender={tender}
                onClick={() => router.push(`/dashboard/company/tenders/my-bids/${tender._id}/bids`)}
              />
            ))}
          </div>
        )}
