            ...
            <SocialDashboardLayout requiredRole="company">
                <RoleThemeProvider>
                    <Card className="backdrop-blur-xl bg-linear-to-b from-white to-gray-100 border border-gray-200 rounded-3xl p-8 text-center">
                        <div className="w-20 h-20 rounded-full bg-linear-to-br from-blue-500 to-purple-500 flex items-center justify-center mx-auto mb-6">
                ...
                <div className="space-y-8 pb-20">
                    ...
                    <div className="fixed bottom-8 right-8 z-50 flex flex-col gap-3">
                        <Button
                            ...
                            className="bg-linear-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white shadow-xl hover:shadow-2xl transition-all duration-300 group"
                            size="lg"
                        >
