        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-6 md:mb-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 md:mb-6 gap-4">
              ...
              <div className="hidden lg:block">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-linear-to-br from-blue-500 to-blue-600 rounded-xl md:rounded-2xl flex items-center justify-center shadow-lg">
          ...
          <div className={`mt-6 md:mt-8 ${colorClasses.bg.blue} bg-opacity-10 rounded-xl md:rounded-2xl p-4 md:p-6 border border-blue-200`}>
            <div className="flex items-start">
              <AlertCircle className="w-4 h-4 md:w-5 md:h-5 text-blue-600 mr-2 md:mr-3 mt-0.5 shrink-0" />
              <div>
