      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-xl text-gray-600 max-w-3xl">
                  Update your job posting to keep it current and attractive to candidates.
                </p>
              </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Current Job Information</h2>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-yellow-800 mb-2">
                    Company Verification Recommended
                  </h3>
                  <p className="text-yellow-700">
                    Verify your company to unlock premium features and increase candidate trust. 
          ...
          <div className="mt-12 bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Track views and applications to optimize your job posting strategy.
                </p>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-blue-800 text-sm">
                    Consider creating a new job posting instead of editing if you`re making significant changes 
