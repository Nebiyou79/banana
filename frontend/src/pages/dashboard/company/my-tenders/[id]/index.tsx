...
// pages/dashboard/company/my-tenders/[id].tsx
...
export default function CompanyTenderDetailsPage() {
  ...
  useEffect(() => {
    if (!authLoading && !user) {
      toast({
        ...
        description: 'Please login to view this tender',
        variant: 'destructive',
      });
  ...
  useEffect(() => {
    if (!authLoading && user && user.role !== 'company' && user.role !== 'organization') {
      toast({
        title: 'Access Denied',
        description: 'You need to be a company or organization to view this tender',
        variant: 'destructive',
      });
  ...
  useEffect(() => {
    if (error && (error.message?.includes('Access denied') || (error as any)?.response?.status === 403)) {
      toast({
        title: 'Access Denied',
        description: error.message || 'You do not have permission to view this tender.',
        variant: 'destructive',
        duration: 5000,
      });
    }
  ...
  const canEditTender = canEditFromHook || false;
              ...
              <CardContent className="flex flex-col items-center justify-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                    {error.message || 'You do not have permission to access this tender.'}
                  </p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    This tender may belong to another company or organization.
                  </p>
                </div>
  ...
  return (
    <>
      <Head>
        <title>{tender.title} | My Tenders</title>
