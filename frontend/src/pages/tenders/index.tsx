...
// pages/tenders/index.tsx - CLEANER VERSION
...
const TendersPage: NextPage = () => {
  ...
  const StatCard = ({ icon: Icon, value, label, color }: any) => (
    <div className="text-center p-4 bg-white/90 backdrop-blur-sm rounded-xl border border-white/20 shadow-sm">
  ...
  const QuickFilter = ({ label, count, active, onClick }: any) => (
    <button
      ...
      className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
        active
          ? `${colorClasses.bg.goldenMustard} ${colorClasses.text.darkNavy} shadow-sm`
  ...
  return (
    <DashboardLayout>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        {/* Clean Modern Header */}
        <div className="relative bg-gradient-to-br from-indigo-950 via-blue-800 to-yellow-500 text-white overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Find Your Next
                <span className="block text-goldenMustard mt-2">Big Project</span>
              </h1>
              
              <p className="text-xl text-blue-100 mb-12 max-w-2xl mx-auto leading-relaxed">
                Connect with top companies and work on meaningful projects. 
                From startups to enterprises, find opportunities that match your skills.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                {user?.role === 'company' && (
                  <button
                    ...
                    className="group flex items-center gap-2 bg-goldenMustard text-darkNavy font-semibold py-3 px-6 rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105"
                  >
