...
export default function AboutUsPage(): JSX.Element {
  ...
  return (
    <DashboardLayout>
      <div className={`min-h-screen bg-linear-to-b from-slate-50 to-white ${colorClasses.text.darkNavy}`}>
        {/* Hero Section */}
        <header className="relative py-12 md:py-20 lg:py-24 bg-linear-to-br from-navy-900 to-navy-800 text-white overflow-hidden">
        ...
        <main className="container mx-auto px-4 sm:px-6 py-10 md:py-16 lg:py-20">
              ...
              <div className="flex flex-col lg:flex-row items-start gap-6 md:gap-8">
                <div className="lg:w-1/3">
                  <div className="sticky top-6 md:top-8">
                    <div className={`p-4 md:p-4 rounded-xl md:rounded-2xl bg-linear-to-br from-yellow-50 to-amber-50 border border-yellow-100 mb-4 md:mb-6 ${colorClasses.text.darkNavy}`}>
                ...
                <div className="lg:w-2/3">
                  ...
                  <div className="space-y-4 md:space-y-6">
                    <div className="p-4 md:p-6 rounded-xl md:rounded-2xl bg-linear-to-r from-blue-50 to-white border border-blue-100">
                    ...
                    <div className="p-4 md:p-6 rounded-xl md:rounded-2xl bg-linear-to-r from-amber-50 to-white border border-amber-100">
                      <h4 className="text-lg md:text-xl font-semibold mb-2 md:mb-3 flex items-center gap-2">
                    ...
                    <div className="p-4 md:p-6 rounded-xl md:rounded-2xl bg-linear-to-r from-slate-50 to-white border border-slate-200">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                        {valuePoints.map((item, index) => (
                          <div key={index} className="flex items-start gap-2 md:gap-3 p-3 rounded-lg bg-white">
                            <div className={`p-1.5 md:p-2 rounded-lg shrink-0 ${index === 0 ? 'bg-blue-100 text-blue-600' :
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
              {services.map((service, index) => (
                <div key={index} className="group bg-white rounded-xl md:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-slate-200">
                  <div className={`p-4 md:p-6 rounded-t-xl md:rounded-t-2xl bg-linear-to-r ${service.color} text-white`}>
          ...
          <section className="max-w-6xl mx-auto mb-12 md:mb-20">
            <div className="bg-linear-to-br from-slate-50 to-white rounded-2xl md:rounded-3xl p-6 md:p-8 border border-slate-200">
              ...
              <div className="space-y-3 md:space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    content: (
                      <div className="space-y-4 md:space-y-6">
                        <div className="p-3 md:p-4 rounded-xl bg-linear-to-r from-blue-50 to-white border border-blue-100">
                        ...
                        <div className="p-3 md:p-4 rounded-xl bg-linear-to-r from-amber-50 to-white border border-amber-100">
          ...
          <section className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
              {/* Contact Information */}
              <div className="bg-linear-to-br from-navy-900 to-navy-800 text-white rounded-2xl md:rounded-3xl p-6 md:p-8">
                ...
                <div className="space-y-4 md:space-y-6">
                  <div className="flex items-start gap-3 md:gap-4">
                    <div className="p-2 md:p-3 rounded-lg md:rounded-xl bg-white/10 shrink-0">
              ...
              <div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-lg md:shadow-xl border border-slate-200">
                ...
                <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-3">
                    <Button
                      type="submit"
                      className="bg-linear-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white px-4 md:px-6 py-2.5 md:py-3 rounded-lg md:rounded-xl font-semibold w-full sm:w-auto"
                    >
        ...
        {/* Final CTA */}
        <section className="py-12 md:py-16 lg:py-20 bg-linear-to-br from-amber-500 to-yellow-500">
