        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 sm:space-y-6">
          ...
          <div className={`flex flex-col sm:flex-row items-center justify-end gap-3 pt-4 sm:pt-6 border-t ${colorClasses.border.gray400}`}>
            ...
            <button
              ...
              className={`px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg sm:rounded-xl hover:shadow-xl transition-all duration-200 font-semibold disabled:opacity-50 w-full sm:w-auto ${colorClasses.text.white} bg-linear-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700`}
            >
              {isSubmitting ? (
