    ...
    <div className={`rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border ${colorClasses.border.gray400} ${colorClasses.bg.white}`}>
      ...
      <div className="mb-4 sm:mb-6">
        <div className={`w-full rounded-full h-2 sm:h-3 shadow-inner ${colorClasses.bg.gray100}`}>
          <div
            className={`h-2 sm:h-3 rounded-full bg-linear-to-r ${getProgressColor(completionScore)} transition-all duration-1000 ease-out`}
        ...
        <div className={`border-t pt-3 sm:pt-4 ${colorClasses.border.gray400}`}>
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
            ...
            {onImprove && (
              <button
                onClick={onImprove}
                className={`px-4 sm:px-6 py-2 sm:py-2.5 rounded-lg sm:rounded-xl hover:shadow-md transition-all duration-200 text-xs sm:text-sm font-semibold whitespace-nowrap w-full sm:w-auto ${colorClasses.text.white} bg-linear-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700`}
              >
                Improve Profile
              </button>
            )}
