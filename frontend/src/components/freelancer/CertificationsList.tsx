                    ...
                    <div className="flex-1 w-full">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 mb-3 sm:mb-4">
                        <div className={`flex items-center text-xs sm:text-sm ${colorClasses.text.gray600}`}>
                          <CalendarIcon className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 shrink-0" />
                        ...
                        {certification.credentialId && (
                          <div className={`flex items-center text-xs sm:text-sm ${colorClasses.text.gray600}`}>
                            <DocumentTextIcon className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 shrink-0" />
                        ...
                        {certification.credentialUrl && (
                          <div className="flex items-center text-xs sm:text-sm">
                            <LinkIcon className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 shrink-0" />
                            <a
