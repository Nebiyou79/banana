        ...
        {[
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className={`text-2xl bg-linear-to-br ${stat.color} bg-clip-text text-transparent`}>
                {stat.icon}
              </div>
            </div>
          </div>
      ...
      {!showLoadMore && posts.length > 0 && (
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-800">
          <button
            ...
            className="group w-full flex items-center justify-between p-4 bg-linear-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl border border-blue-200 dark:border-blue-800 hover:border-blue-500 dark:hover:border-blue-400 transition-colors"
          >
            <div className="flex items-center gap-3">
