    ...
    return (
        <div className="relative inline-block group">
            ...
            >
                ...
                />
                <AvatarFallback className="font-medium bg-linear-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800">
                    {fallback || initials}
                </AvatarFallback>
            </Avatar>
            ...
            {isPremium && verificationStatus !== 'full' && (
                <div
                    className={cn(
                        "absolute bg-linear-to-r from-amber-500 to-yellow-500 text-white rounded-full border-2 border-white dark:border-gray-800 flex items-center justify-center",
