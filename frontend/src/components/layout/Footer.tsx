        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center space-x-3 mb-6">
              ...
              <span className="text-2xl font-bold text-white">
                Banana <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-gray-500">Jobs</span>
              </span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/companies" className="text-gray-400 hover:text-white transition-colors">Browse Companies</Link></li>
              <li><Link href="/freelancers" className="text-gray-400 hover:text-white transition-colors">Find Talent</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/resume-tips" className="text-gray-400 hover:text-white transition-colors">Resume Tips</Link></li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">info@nexusjobs.com</span>
              </div>
              <div className="flex items-center space-x-3">
