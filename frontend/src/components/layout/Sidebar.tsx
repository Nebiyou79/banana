  ...
  const getNavigationItems = () => {
    ...
    const roleItems = {
      ...
      company: [
        ...
        { href: "/dashboard/company/my-tenders/create", label: "Create Tender", icon: Award },
        { href: "/dashboard/company/my-tenders", label: "My Tenders", icon: Man2Rounded },
        { href: "/dashboard/company/tenders", label: "Browse Tenders", icon: List },
        { href: "/dashboard/company/tenders/saved", label: "Saved Tenders", icon: BarChart3 },
