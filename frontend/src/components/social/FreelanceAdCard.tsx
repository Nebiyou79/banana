    ...
    return (
        <div className={`group relative ${className}`}>
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                {/* Header */}
                <div className="relative h-48 bg-linear-to-r from-amber-500 to-amber-600">
                    ...
                    <div className="absolute top-4 left-4 flex flex-col gap-2">
                        {urgent && (
                            <div className="flex items-center gap-1 px-3 py-1.5 bg-linear-to-r from-red-500 to-red-600 text-white rounded-full text-xs font-semibold backdrop-blur-sm animate-pulse">
                ...
                <div className="p-6">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                        <div className="w-12 h-12 rounded-xl bg-linear-to-br from-amber-500 to-amber-600 flex items-center justify-center shadow-lg">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4">
                        <div className="bg-linear-to-br from-amber-50 to-amber-100 rounded-xl p-3">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {skills.slice(0, 4).map((skill, index) => (
                                <span
                                    key={index}
                                    className="px-3 py-1.5 bg-linear-to-r from-amber-50 to-amber-100 text-amber-700 rounded-lg text-sm font-medium"
                                >
                                    {skill}
                                </span>
                            ))}
                    ...
                    <button
                        onClick={handleClick}
                        className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-linear-to-r from-amber-600 to-amber-700 text-white rounded-xl font-semibold hover:from-amber-700 hover:to-amber-800 transition-all duration-300 group"
                    >
                        {cta}
