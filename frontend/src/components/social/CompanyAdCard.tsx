  ...
  return (
    <div className={`group relative ${className}`}>
      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
        {/* Header */}
        <div className="relative h-48 bg-linear-to-r from-purple-500 to-purple-600">
          ...
          <div className="absolute top-4 left-4 flex flex-col gap-2">
            {enterprise && (
              <div className="flex items-center gap-1 px-3 py-1.5 bg-linear-to-r from-purple-600 to-purple-700 text-white rounded-full text-xs font-semibold backdrop-blur-sm">
        ...
        <div className="p-6">
          ...
          <button
            onClick={handleClick}
            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-linear-to-r from-purple-600 to-purple-700 text-white rounded-xl font-semibold hover:from-purple-700 hover:to-purple-800 transition-all duration-300 group"
          >
            {cta}
