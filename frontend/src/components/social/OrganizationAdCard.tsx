    ...
    return (
        <div className={`group relative ${className}`}>
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                {/* Header */}
                <div className="relative h-48 bg-linear-to-r from-emerald-500 to-emerald-600">
                    ...
                    <div className="absolute top-4 left-4 flex flex-col gap-2">
                        {verified && (
                            <div className="flex items-center gap-1 px-3 py-1.5 bg-linear-to-r from-emerald-600 to-emerald-700 text-white rounded-full text-xs font-semibold backdrop-blur-sm">
                ...
                <div className="p-6">
                        ...
                        <div className="mb-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {partners.slice(0, 3).map((partner, index) => (
                                    <span
                                        key={index}
                                        className="px-3 py-1.5 bg-linear-to-r from-emerald-50 to-emerald-100 text-emerald-700 rounded-lg text-sm font-medium"
                                    >
                                        {partner}
                                    </span>
                                ))}
                    ...
                    <div className="grid grid-cols-3 gap-3 mb-6">
                        <div className="bg-linear-to-br from-emerald-50 to-emerald-100 rounded-xl p-3 text-center">
                    ...
                    <button
                        onClick={handleClick}
                        className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-linear-to-r from-emerald-600 to-emerald-700 text-white rounded-xl font-semibold hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 group"
                    >
                        {cta}
