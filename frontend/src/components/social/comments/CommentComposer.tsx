        ...
        <div className={`flex ${compact ? 'items-start gap-2' : 'items-start gap-3'}`}>
          ...
          {showAvatar && currentUser && (
            <div className="flex-shrink-0 pt-1">
              <Avatar className={`${compact ? "h-7 w-7" : "h-9 w-9"} ring-1 ring-gray-100`}>
                <AvatarImage
                  src={currentUser.avatar}
                  alt={currentUser.name}
                  className="object-cover"
                />
                <AvatarFallback className="bg-gradient-to-br from-blue-50 to-indigo-50 text-blue-600 text-sm">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="relative">
              <textarea
                ...
                className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl resize-none text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm transition-all duration-200 hover:border-gray-300 disabled:bg-gray-50 disabled:cursor-not-allowed"
                style={{
                ...
                <div className="flex items-center gap-2">
                  {(onCancel || parentCommentId) && (
                    <Button
                      ...
                      disabled={isSubmitting}
                      className="text-gray-600 hover:text-gray-900 px-3 text-sm"
                    >
                      Cancel
                    </Button>
                  )}
                  ...
                  <Button
                    ...
                    className="px-4 font-medium bg-blue-600 hover:bg-blue-700 text-white text-sm"
                  >
                    {submitLabel}
                  </Button>
                </div>
