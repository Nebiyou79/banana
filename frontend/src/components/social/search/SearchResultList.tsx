...
const SearchResultList: React.FC<SearchResultListProps> = ({
    ...
    const getTypeColor = (type: string) => {
        const colors: Record<string, string> = {
            'candidate': 'bg-linear-to-r from-orange-100 to-orange-50 text-orange-800 border border-orange-200',
            'freelancer': 'bg-linear-to-r from-green-100 to-green-50 text-green-800 border border-green-200',
            'company': 'bg-linear-to-r from-purple-100 to-purple-50 text-purple-800 border border-purple-200',
            'organization': 'bg-linear-to-r from-indigo-100 to-indigo-50 text-indigo-800 border border-indigo-200',
            'user': 'bg-linear-to-r from-blue-100 to-blue-50 text-blue-800 border border-blue-200'
        };
        return colors[type] || 'bg-linear-to-r from-gray-100 to-gray-50 text-gray-800 border border-gray-200';
    };
        ...
        return (
            <div className="flex flex-col items-center justify-center py-20">
                <div className="relative">
                    ...
                    <div className="absolute inset-0 bg-linear-to-r from-blue-500/20 to-purple-500/20 blur-xl rounded-full"></div>
                </div>
        ...
        return (
            <div className="flex flex-col items-center justify-center py-20">
                <div className="relative mb-6">
                    ...
                    <div className="absolute inset-0 bg-linear-to-r from-red-500/20 to-pink-500/20 blur-xl rounded-full"></div>
                </div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Search Error</h3>
                <p className="text-gray-600 text-center max-w-md">{error}</p>
                <button
                    onClick={() => window.location.reload()}
                    className="mt-6 px-6 py-3 bg-linear-to-r from-blue-600 to-purple-600 text-white rounded-xl font-medium hover:shadow-lg transition-all"
                >
                    Try Again
                </button>
            </div>
        ...
        return (
            <div className="flex flex-col items-center justify-center py-20">
                <div className="relative mb-6">
                    ...
                    <div className="absolute inset-0 bg-linear-to-r from-gray-200/20 to-gray-300/20 blur-xl rounded-full"></div>
                </div>
