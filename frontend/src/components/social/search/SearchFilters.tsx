...
const SearchFilters: React.FC<SearchFiltersProps> = ({
    ...
    const getProfileTypeColor = (type: string) => {
        switch (type) {
            case 'candidate': return 'bg-linear-to-r from-orange-100 to-orange-50 text-orange-800 border-orange-200';
            case 'freelancer': return 'bg-linear-to-r from-green-100 to-green-50 text-green-800 border-green-200';
            case 'company': return 'bg-linear-to-r from-purple-100 to-purple-50 text-purple-800 border-purple-200';
            case 'organization': return 'bg-linear-to-r from-indigo-100 to-indigo-50 text-indigo-800 border-indigo-200';
            default: return 'bg-linear-to-r from-blue-100 to-blue-50 text-blue-800 border-blue-200';
        }
    };
    ...
    return (
        <div className={cn('w-full', className)}>
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8 p-6 bg-white/90 backdrop-blur-xl rounded-2xl border border-white/50 shadow-lg">
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2 text-gray-700">
                        ...
                        {hasActiveFilters() && (
                            <span className="px-2.5 py-1 text-xs font-medium bg-linear-to-r from-blue-500 to-purple-500 text-white rounded-full">
            ...
            {!isExpanded && (
                <div className="flex flex-wrap gap-3 mb-8 p-5 bg-linear-to-r from-blue-50/50 to-purple-50/50 rounded-2xl border border-blue-100">
            ...
            {isExpanded && (
                <div className="mb-8 p-8 bg-linear-to-br from-white to-gray-50/50 rounded-2xl border border-gray-200 shadow-xl">
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            filters.type === skill.value
                                                ? 'bg-linear-to-r from-blue-100 to-blue-50 border-2 border-blue-200'
                    ...
                    {hasActiveFilters() && (
                        <div className="mt-8 pt-8 border-t border-gray-200">
                            ...
                            <div className="flex flex-wrap gap-3">
                                {filters.type !== 'all' && (
                                    <div className="px-4 py-2 bg-linear-to-r from-blue-100 to-blue-50 text-blue-800 rounded-xl flex items-center gap-2 text-sm font-medium border border-blue-200">
                                ...
                                {filters.location && (
                                    <div className="px-4 py-2 bg-linear-to-r from-green-100 to-green-50 text-green-800 rounded-xl flex items-center gap-2 text-sm font-medium border border-green-200">
                                ...
                                {selectedSkills.length > 0 && (
                                    <div className="px-4 py-2 bg-linear-to-r from-purple-100 to-purple-50 text-purple-800 rounded-xl flex items-center gap-2 text-sm font-medium border border-purple-200">
                                ...
                                {(filters.minFollowers || filters.maxFollowers) && (
                                    <div className="px-4 py-2 bg-linear-to-r from-pink-100 to-pink-50 text-pink-800 rounded-xl flex items-center gap-2 text-sm font-medium border border-pink-200">
