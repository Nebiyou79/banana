                            ...
                            <div className="flex flex-wrap gap-2">
                                {trendingHashtags.map((tag) => (
                                    <button
                                        ...
                                        className="group inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-linear-to-r from-blue-50 to-purple-50 border border-blue-100 hover:border-blue-300 hover:shadow-md transition-all"
                                    >
