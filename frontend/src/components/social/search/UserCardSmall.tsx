...
const UserCardSmall: React.FC<UserCardSmallProps> = ({
    ...
    const getProfileTypeColor = () => {
        switch (profile.type) {
            case 'company': return 'bg-linear-to-r from-blue-100 to-blue-50 text-blue-700 border border-blue-200';
            case 'organization': return 'bg-linear-to-r from-purple-100 to-purple-50 text-purple-700 border border-purple-200';
            case 'freelancer': return 'bg-linear-to-r from-green-100 to-green-50 text-green-700 border border-green-200';
            case 'candidate': return 'bg-linear-to-r from-orange-100 to-orange-50 text-orange-700 border border-orange-200';
            default: return 'bg-linear-to-r from-gray-100 to-gray-50 text-gray-700 border border-gray-200';
        }
    };
    ...
    return (
        <div
            ...
            className={cn(
                'group relative bg-linear-to-br from-white to-gray-50/50 rounded-2xl border border-gray-200 p-6 hover:border-blue-300 hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden',
        ...
        >
                ...
                <div className="shrink-0 relative">
                    <div className={cn(
                        ...
                        {profile.avatar ? (
                            ...
                            <div className="w-full h-full flex items-center justify-center text-3xl font-bold text-white relative z-10 bg-linear-to-br from-blue-600 to-purple-600">
                        ...
                        {featured && (
                            <div className="absolute -top-2 -right-2 z-20">
                                <div className="bg-linear-to-r from-amber-500 to-orange-500 text-white text-xs font-bold px-2 py-1 rounded-full flex items-center gap-1">
                    ...
                    {isVerified && (
                        <div className="absolute -bottom-2 -right-2 z-20">
                            <div className="w-8 h-8 bg-linear-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center shadow-lg border-2 border-white">
                    ...
                    {profile.skills && profile.skills.length > 0 && !compact && (
                        <div className="flex flex-wrap gap-2 mb-4">
                            {profile.skills.slice(0, 4).map((skill) => (
                                <span
                                    key={skill}
                                    className="px-3 py-1.5 bg-linear-to-r from-gray-100 to-gray-50 text-gray-700 text-xs font-medium rounded-lg border border-gray-200"
                                >
                                    {skill}
                                </span>
                            ))}
                            {profile.skills.length > 4 && (
                                <span className="px-3 py-1.5 bg-linear-to-r from-gray-100 to-gray-50 text-gray-500 text-xs font-medium rounded-lg border border-gray-200">
            ...
            <div className="absolute inset-0 bg-linear-to-r from-blue-500/0 via-purple-500/0 to-pink-500/0 group-hover:from-blue-500/5 group-hover:via-purple-500/5 group-hover:to-pink-500/5 transition-all duration-500 pointer-events-none"></div>
        </div>
    );
};
