...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-white transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95",
  {
    variants: {
      variant: {
        // Default variants
        default: "bg-linear-to-r from-yellow-400 to-orange-500 text-white shadow-lg hover:shadow-xl hover:from-yellow-500 hover:to-orange-600",
        destructive: "bg-linear-to-r from-red-500 to-pink-600 text-white shadow-lg hover:shadow-xl hover:from-red-600 hover:to-pink-700",
        outline: "border-2 border-gray-300 bg-white text-gray-700 hover:bg-gray-50 hover:border-yellow-400 hover:text-gray-900",
        secondary: "bg-linear-to-r from-blue-500 to-purple-600 text-white shadow-lg hover:shadow-xl hover:from-blue-600 hover:to-purple-700",
        ghost: "text-gray-600 hover:bg-gray-100 hover:text-gray-900",
        link: "text-gray-900 underline-offset-4 hover:underline",
        
        // Premium dark theme variants
        premium: "bg-linear-to-r from-amber-500 to-yellow-600 text-white shadow-lg hover:shadow-xl hover:from-amber-600 hover:to-yellow-700 border border-amber-400/30",
        ...
        "premium-destructive": "bg-linear-to-r from-red-600 to-pink-700 text-white shadow-lg hover:shadow-xl hover:from-red-700 hover:to-pink-800 border border-red-400/30",
        
        // Social media specific variants
        "social-primary": "bg-linear-to-r from-blue-500 to-purple-600 text-white shadow-lg hover:shadow-xl hover:from-blue-600 hover:to-purple-700",
        "social-secondary": "bg-linear-to-r from-green-500 to-emerald-600 text-white shadow-lg hover:shadow-xl hover:from-green-600 hover:to-emerald-700",
        "social-ghost": "text-gray-600 hover:bg-gray-100 hover:text-gray-900 border border-gray-200",
        
        // Premium social variants
        "premium-social": "bg-linear-to-r from-amber-500 to-yellow-600 text-white shadow-lg hover:shadow-xl hover:from-amber-600 hover:to-yellow-700 border border-amber-400/30 backdrop-blur-sm",
