...
export const OrganizationCard: React.FC<OrganizationCardProps> = ({
  ...
  if (variant === 'featured') {
    return (
      <div 
        onClick={handleClick}
        className={`bg-linear-to-br from-white to-gray-50 rounded-xl p-6 border border-gray-200 hover:border-teal-300 hover:shadow-lg transition-all duration-300 cursor-pointer group ${className}`}
      >
        <div className="flex items-start space-x-4">
          ...
          {organization.logoFullUrl ? (
            ...
            <div className="w-16 h-16 rounded-xl bg-linear-to-br from-teal-500 to-teal-600 border-2 border-white shadow-lg flex items-center justify-center shrink-0">
