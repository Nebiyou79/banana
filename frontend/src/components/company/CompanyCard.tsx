...
export default function CompanyCard({ company, showActions = false, onView }: CompanyCardProps) {
  ...
  return (
    <Card className="group relative bg-linear-to-br from-white to-gray-50/80 hover:to-blue-50/50 border border-gray-200/60 hover:border-blue-300/50 shadow-sm hover:shadow-xl transition-all duration-500 overflow-hidden backdrop-blur-sm">
      ...
      <div className="relative h-24 bg-linear-to-r from-blue-500 to-indigo-600 overflow-hidden">
        {coverPhoto ? (
          ...
          <div className="absolute inset-0 bg-linear-to-r from-blue-500 to-indigo-600 flex flex-col items-center justify-center">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2 -mt-12">
              <div className="relative">
                <div className="w-16 h-16 rounded-xl border-2 border-white bg-white shadow-2xl overflow-hidden shrink-0 group-hover:shadow-blue-500/25 transition-all duration-300 relative group/logo">
                  {avatar ? (
                    <>
                      <img
                        src={avatar}
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <CardTitle className="text-lg font-bold truncate bg-linear-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
                    {company.name}
                  </CardTitle>
                </div>
          ...
          <div className="space-y-2 text-sm">
            {company.address && (
              <div className="flex items-center gap-2 group/item">
                <MapPin className="w-3 h-3 text-blue-600 shrink-0 group-hover/item:scale-110 transition-transform" />
            ...
            {company.phone && (
              <div className="flex items-center gap-2 group/item">
                <Phone className="w-3 h-3 text-green-600 shrink-0 group-hover/item:scale-110 transition-transform" />
            ...
            {company.website && (
              <div className="flex items-center gap-2 group/item">
                <Globe className="w-3 h-3 text-purple-600 shrink-0 group-hover/item:scale-110 transition-transform" />
                <a
