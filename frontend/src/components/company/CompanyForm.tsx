...
export default function CompanyForm({
  ...
  return (
    <Card className={`border-0 shadow-2xl ${colorClasses.bg.white} dark:bg-gray-800 bg-gradient-to-br from-white to-blue-50/30 dark:from-gray-800 dark:to-gray-900 backdrop-blur-sm transition-colors duration-200`}>
      <CardHeader className="pb-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription className={`text-lg mt-2 ${colorClasses.text.gray600} dark:text-gray-400`}>
              {isCreateMode
                ? 'Fill in your company details to get started'
                : 'Update your company information'}
              <span className={`ml-2 inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${colorClasses.bg.blueLight} ${colorClasses.text.blue600} dark:bg-blue-900/30 dark:text-blue-400`}>
          ...
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-8">
            ...
            <div className="space-y-6">
              <div className={`p-4 ${colorClasses.bg.blueLight} dark:bg-blue-900/20 rounded-xl border ${colorClasses.border.blue} dark:border-blue-800`}>
                <div className="flex items-center gap-2 mb-4">
                  <Cloud className={`w-5 h-5 ${colorClasses.text.blue} dark:text-blue-400`} />
                ...
                {(avatarUploading || coverUploading) && (
                  <div className={`mt-4 p-3 ${colorClasses.bg.blueLight} dark:bg-blue-900/30 rounded-lg border ${colorClasses.border.blue} dark:border-blue-800`}>
                    <div className={`flex items-center gap-2 ${colorClasses.text.blue600} dark:text-blue-400 text-sm`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className={`${colorClasses.text.gray700} dark:text-gray-300 font-semibold flex items-center gap-2`}>
                      <Building2 className={`w-4 h-4 ${colorClasses.text.blue} dark:text-blue-400`} />
                      Company Name *
                    </FormLabel>
                    <FormControl>
                      <Input
                        ...
                        {...field}
                        className={`border-gray-300 dark:border-gray-700 dark:bg-gray-700 dark:text-white focus:border-blue-500 focus:ring-blue-500 transition-colors`}
                        disabled={isSubmitting || avatarUploading || coverUploading}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className={`${colorClasses.text.gray700} dark:text-gray-300 font-semibold flex items-center gap-2`}>
                      <Shield className={`w-4 h-4 ${colorClasses.text.green} dark:text-green-400`} />
                      TIN Number
                    </FormLabel>
                    <FormControl>
                      <Input
                        ...
                        {...field}
                        className={`border-gray-300 dark:border-gray-700 dark:bg-gray-700 dark:text-white focus:border-green-500 focus:ring-green-500 transition-colors`}
                        disabled={isSubmitting || avatarUploading || coverUploading}
                      />
                    </FormControl>
                    <FormDescription className={`${colorClasses.text.gray600} dark:text-gray-500`}>Tax Identification Number</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className={`${colorClasses.text.gray700} dark:text-gray-300 font-semibold`}>Industry</FormLabel>
                    <FormControl>
                      <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className={`${colorClasses.text.gray700} dark:text-gray-300 font-semibold flex items-center gap-2`}>
                      <Phone className={`w-4 h-4 ${colorClasses.text.green} dark:text-green-400`} />
                      Phone
                    </FormLabel>
                    <FormControl>
                      <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className={`${colorClasses.text.gray700} dark:text-gray-300 font-semibold flex items-center gap-2`}>
                      <Globe className={`w-4 h-4 ${colorClasses.text.purple} dark:text-purple-400`} />
                      Website
                    </FormLabel>
                    <FormControl>
                      <Input
                        ...
                        {...field}
                        className={`border-gray-300 dark:border-gray-700 dark:bg-gray-700 dark:text-white focus:border-purple-500 focus:ring-purple-500 transition-colors`}
                        disabled={isSubmitting || avatarUploading || coverUploading}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="md:col-span-2">
                    <FormLabel className={`${colorClasses.text.gray700} dark:text-gray-300 font-semibold flex items-center gap-2`}>
                      <MapPin className={`w-4 h-4 ${colorClasses.text.red} dark:text-red-400`} />
                      Address
                    </FormLabel>
                    <FormControl>
                      <Input
                        ...
                        {...field}
                        className={`border-gray-300 dark:border-gray-700 dark:bg-gray-700 dark:text-white focus:border-red-500 focus:ring-red-500 transition-colors`}
                        disabled={isSubmitting || avatarUploading || coverUploading}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="md:col-span-2">
                    <FormLabel className={`${colorClasses.text.gray700} dark:text-gray-300 font-semibold`}>Description</FormLabel>
                    <FormControl>
                      <Textarea
                        placeholder="Describe your company, services, and mission..."
                        className={`min-h-32 border-gray-300 dark:border-gray-700 dark:bg-gray-700 dark:text-white focus:border-blue-500 focus:ring-blue-500 transition-colors resize-none`}
                        {...field}
                        disabled={isSubmitting || avatarUploading || coverUploading}
                      />
                    </FormControl>
                    <FormDescription className={`${colorClasses.text.gray400} dark:text-gray-500`}>
            ...
            {/* Action Buttons */}
            <div className="flex gap-4 pt-6 border-t ${colorClasses.border.gray200} dark:border-gray-700">
              <Button
                type="submit"
              ...
              <Button
                ...
                onClick={handleCancel}
                disabled={isSubmitting || avatarUploading || coverUploading}
                className={`border-gray-300 dark:border-gray-700 hover:border-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors`}
              >
                Cancel
              </Button>
            </div>
            ...
            {/* Help Text */}
            <div className={`p-4 ${colorClasses.bg.blueLight} dark:bg-blue-900/20 rounded-lg border ${colorClasses.border.blue} dark:border-blue-800`}>
              <p className={`text-sm ${colorClasses.text.blue600} dark:text-blue-400 flex items-start gap-2`}>
