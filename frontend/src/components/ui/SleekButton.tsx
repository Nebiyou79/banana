...
export const SleekButton: React.FC<SleekButtonProps> = ({ 
  ...
  const getVariantClasses = () => {
    switch (variant) {
      ...
      case "gradient":
        return "bg-linear-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white focus:ring-purple-500 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:translate-y-0";
      
      case "danger":
        return "bg-linear-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 text-white focus:ring-red-500 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:translate-y-0";
