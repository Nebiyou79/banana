import { Scale, Shield, Users, BookOpen, Mail } from 'lucide-react';

export default function TermsOfServiceContent() {
  return (
    <div className="prose max-w-none">
      <p className="text-gray-700 mb-6">
        Welcome to TalentHub! These Terms of Service govern your use of our platform and provide 
        information about the TalentHub service, outlined below. When you create a TalentHub account 
        or use TalentHub, you agree to these terms.
      </p>

      <div className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
          <Scale className="mr-2 text-blue-600" size={20} />
          1. The TalentHub Service
        </h2>
        <p className="text-gray-700">
          We agree to provide you with the TalentHub Service. The Service includes all of the 
          TalentHub products, features, applications, services, technologies, and software that 
          we provide to advance TalentHub`s mission: To connect professionals with opportunities 
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-700 mb-2 font-medium">Who Can Use TalentHub:</p>
        <p className="text-gray-700 mb-4">
          ...
          restrictions in order to be part of the TalentHub community.
        </p>
      ...
      <div className="bg-blue-50 p-6 rounded-lg">
        ...
        <p className="text-gray-700">
          Email: <span className="text-blue-600">terms@talenthub.com</span>
        </p>
        <p className="text-gray-700">
