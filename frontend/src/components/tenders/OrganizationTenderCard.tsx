...
// components/tenders/OrganizationTenderCard.tsx - NEW COMPONENT
...
interface OrganizationTenderCardProps {
  tender: Tender;
...
const OrganizationTenderCard: React.FC<OrganizationTenderCardProps> = ({ 
  tender, 
  onSaveToggle, 
  onEdit,
  onDelete,
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-start mb-3">
          <div className="flex-1">
            ...
            <Link href={`/dashboard/organization/tenders/${tenderId}`}>
          ...
          <div className="flex items-center gap-1">
            {onSaveToggle && (
              ...
              >
                {saved ? (
                  <BookmarkSolid className="h-5 w-5 text-purple-500" />
                ) : (
        ...
        <div className="mt-4 flex gap-2">
          <Link href={`/dashboard/organization/tenders/${tenderId}`} className="flex-1">
            <button className="w-full bg-purple-600 hover:bg-purple-700 text-white py-2 px-4 rounded-md transition-colors text-sm font-medium">
              View Details
            </button>
          </Link>
...
export default OrganizationTenderCard;